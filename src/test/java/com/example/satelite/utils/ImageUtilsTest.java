...
class ImageUtilsTest {
    ...
    @Test
    void deveRecortarRodapeRedimensionarEGravarJpegComDpiPpg() throws Exception {
        ImageUtils imageUtils = new ImageUtils(0.18);
        byte[] imagemOriginal = criarImagemComRodapeVermelho();
    ...
    private byte[] criarImagemComRodapeVermelho() throws IOException {
        BufferedImage imagem = new BufferedImage(1000, 1000, BufferedImage.TYPE_INT_RGB);
        Graphics2D g2d = imagem.createGraphics();

        g2d.setColor(Color.BLACK);
        g2d.fillRect(0, 0, 1000, 820);
        g2d.setColor(Color.RED);
        g2d.fillRect(0, 820, 1000, 180);
        g2d.dispose();
