...
set "LIMIT=%~1"
if not defined LIMIT set "LIMIT=500"
...
echo.
echo Previa Vedacit de todos os registros elegiveis, ate %LIMIT% por execucao: le SFTP e XML ESL para classificar. Nao envia SOAP e nao altera status.
